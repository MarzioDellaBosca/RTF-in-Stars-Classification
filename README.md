The purpose of the project is to implement a Random Tree Forest algorithm to observe its learning ability and skill in classifying celestial bodies by dividing them into three major groups based on 
